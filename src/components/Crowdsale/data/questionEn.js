...
const data = [
  ...
  {title: 'What is the relationship between Wanchain and Wanglu Tech?',
    describe: 'The Wanchain Foundation, registered in Singapore, is a non-profit organization that serves the Wanchain community. It is responsible for raising operating funds for the Wanchain community and offering support to enterprises, organizations and individuals. The foundation supports the Wanchain open-source project. It formulates fund-raising plans and institutes rules for using the corresponding funds.' +
    'Wanglu Tech is a for-profit company specializing in R&D and commercialization of the underlying blockchain technologies. River Capital and Fenbushi Capital have both invested in the company. The Wanchain theories and partial implementation are attributed to the Wanglu Tech team, which applies its prior R&D achievements to the Wanchain open-source project and is a participant of the Wanchain open-source community. Later, the Wanglu Tech team will continue to develop commercial blockchain applications in financial and other relevant areas and to build consortium blockchains for a diverse Wanchain ecological system. '
  },
  ...
  {title: 'Are the tokens from this crowdfunding venture permitted to be transferred to other accounts?',
    describe: "Yes. After the crowdfunding venture is finished, tokens will be allocated to the users' Ethereum wallets, through which transfers are possible. This is similar to the transfer of smart contract tokens on Ethereum."
  },
  ...
  {title: 'What can Wancoin, the primary currency of Wanchain, be used for after Wanchain is online?',
    describe: `Two main roles for the Wancoin are:
    1) process fees for Wanchain transactions and cross-chain transactions and,
    2) bond deposits at each node for ensuring cross-chain transactions. 
    In terms of applications, as more and more cross-chain transactions are processed by Wanchain and as Wancoin appreciates in value, Wancoin will become an intermediate currency for currency exchanges. This is similar to being the transaction medium for other currencies or digital assets.`
  },
];
