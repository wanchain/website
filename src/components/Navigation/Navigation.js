                    ...
                    { !navButton && clientWidth <= 1024 && language === 'zn' &&
                        <div className={styles.navHeaderUl} id="navbar-menu" style={{display: 'none'}}>
                            <ul>
                                ...
                                <li><a href="https://wanchain.github.io/explorewanchain/#/zh-cn/" target="_blank">文档</a></li>
                                ...
                                <li>
                                    <div className={styles.navDropdown}>
                                        ...
                                        <div className={styles['navDropdown-content']}>
                                            ...
                                            <a href="https://wanchain.github.io/explorewanchain/#/zh-cn/" target="_blank">文档</a>
