  ...
  return (
      <div className={styles} id="navbar-menu" style={style}>
          <ul>
              ...
              <li><a href="https://wanchain.github.io/explorewanchain/#/zh-cn/" target="_blank">文档库</a></li>
                ...
                <li>
                    <div className={homeDropdown}>
                        ...
                        <div className={content}>
                            ...
                            <a href="https://wanchain.github.io/explorewanchain/#/zh-cn/" target="_blank">文档库</a>
