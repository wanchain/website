...
@connect(
    ...
    {insertNewsFunc, getTableStateFunc, warningOpenFunc, warningCloseFunc, warningMsgFunc})
export default class Add extends Component {
    ...
    onBack() {
      this.props.getTableStateFunc(0);
    }
    ...
    render() {
      ...
      return (
            <div>
                <Helmet script={[{src: '/wangeditor/js/require.js', 'data-main': '/wangeditor/js/main'}]} link ={[{href: '/wangeditor/editor/css/wangEditor.min.css', type: 'text/css', rel: 'stylesheet'}]}/>
                <div>
