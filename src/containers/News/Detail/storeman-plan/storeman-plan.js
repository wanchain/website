            ...
            <div className={styles.storemanPlanCom}>
              <div className={styles.storemanPlanDiv}>
                ...
                <ul>
                  ...
                  <h3>Wanchain 3.0，跨链比特币、以太坊和ERC-20</h3>
                  <li>Wanchain 3.0的发布，意味着Wanchain打通了比特币、以太坊和ERC-20通证之间的跨链交易。这将对任何基于以太坊开发的项目在跨链应用上起到示范作用。通过Wanchain跨链机制，任何基于以太坊的应用、协议和去中心化交易都将打破壁垒，实现互联互通。例如，原本基于以太坊创建的去中心化交易所或者直接在Wanchain上创建的去中心化交易所都将能够利用Wanchain3.0的跨链技术实现现有代币与比特币的交易对。支持与比特币的交易会极大提升去中心化交易的资产流动性。此外，跨链技术还能极大拓展资产借贷、代币支付等领域的业务场景。任何目前受限于以太坊单一网络的应用，都将能够连入比特币生态。实现跨链比特币、以太坊和ERC-20（如Dai，LRC），将会给万维链甚至全行业带来深刻的影响。</li>
                </ul>
              </div>
            </div>
      );
