  ...
  render() {
    ...
    return (<div className={styles.content}>
      <h2 className={styles.cH2}>
        <span className={styles.chsColor}>C</span>
        ...
        <div className={styles.comMobDiv}>
          <div className="comMobileP">
            <ul className={styles.mbUl}>
              ...
              <li className={styles.mbuLi2}>
                <em className="cdpXia"><img src={sanjiao}/></em>
              </li>
            </ul>
            ...
            <div className="w">
              ...
              <div className="tbDiv">
                ...
                <p className="comtdP">
                  ...
                  <span>
                    -Prior experience with automation tools are preferred</span>
                  ...
                  <span>-Great communication skill
                  </span>
            ...
            <div className="w">
              ...
              <div className="tbDiv">
                ...
                <p className="comtdP">
                  ...
                  <span>- Local Blockchain community ties.
                  </span>
                  <span>- Able to organize local and global meet-ups for the community.
                  </span>
