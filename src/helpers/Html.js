    ...
    return (
      <html lang="en-us">
        <head>
          ...
          {global.language === 'zh-CN' && <title >万维链(Wanchain)-资产跨链+隐私保护+智能合约 构建数字新经济基础设施</title>}
          {global.language !== 'zh-CN' && <title >wanchain-A Distributed 'Super Financial Market'</title>}
